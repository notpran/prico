  ...
  const handleSubmit = async (e: React.FormEvent, type: 'login' | 'signup') => {
    ...
    try {
      if (type === 'login') {
        ...
        // After signup, show success message or redirect to email verification
      ...
      <div className="w-full max-w-4xl grid md:grid-cols-2 gap-8 items-center">
        ...
        <Card className="bg-black/40 backdrop-blur-sm border-indigo-500/20">
          ...
          <CardContent className="space-y-6">
            {error && (
              <div className="p-3 rounded-md bg-red-900/20 border border-red-600 text-red-400 text-sm">
                {error}
              </div>
            )}
